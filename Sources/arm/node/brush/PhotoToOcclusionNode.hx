...
@:keep
class PhotoToOcclusionNode extends LogicNode {
	...
	override function get(from: Int): Dynamic {
		// kha.Assets.loadBlobFromPath("data/photo_to_occlusion.quant.onnx", function(blob_occlusion: kha.Blob) {
		...
		// 	var buf = Krom.mlInference(untyped blob_occlusion.toBytes().b.buffer, f32.buffer);
		...
		// 	Krom.fileSaveBytes("C:\\Users\\lubos\\Desktop\\test\\photo_occlusion.jpg", out.getBytes().getData(), out.getBytes().length);
		// });
