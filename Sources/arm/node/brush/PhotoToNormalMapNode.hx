...
@:keep
class PhotoToNormalMapNode extends LogicNode {
	...
	override function get(from: Int): Dynamic {
		// kha.Assets.loadBlobFromPath("data/photo_to_normal.quant.onnx", function(blob_normal: kha.Blob) {
		...
		// 	var buf = Krom.mlInference(untyped blob_normal.toBytes().b.buffer, f32.buffer);
		...
		// 	Krom.fileSaveBytes("C:\\Users\\lubos\\Desktop\\test\\photo_normal.jpg", out.getBytes().getData(), out.getBytes().length);
		// });
