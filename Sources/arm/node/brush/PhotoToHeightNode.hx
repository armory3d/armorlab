...
@:keep
class PhotoToHeightNode extends LogicNode {
	...
	override function get(from: Int): Dynamic {
		// kha.Assets.loadBlobFromPath("data/photo_to_height.quant.onnx", function(blob_height: kha.Blob) {
		...
		// 	var buf = Krom.mlInference(untyped blob_height.toBytes().b.buffer, f32.buffer);
		...
		// 	Krom.fileSaveBytes("C:\\Users\\lubos\\Desktop\\test\\photo_height.jpg", out.getBytes().getData(), out.getBytes().length);
		// });
